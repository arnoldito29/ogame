                    ...
                    <div class="find__container find__container-left">
                        ...
                        <div class="find__row">
                            <div class="input__container find__input-container find__input-from">
                                ...
                                <input type="text" name="from" id="ride_from" class="input" placeholder="{{trans( 'ride.Leaving from') }}">
                        ...
                        <div class="find__row">
                            <div class="input__container find__input-container find__input-to">
                                <span class="input__addon-left"></span>
                                <input type="text" name="to" id="ride_to" class="input" placeholder="{{trans( 'ride.Going to') }}">
                        ...
                        <div class="find__row">
                            <div class="input__container find__input-container find__input-calendar">
                                <span class="input__addon-left">{{trans( 'ride.From:') }}</span>
                        ...
                        <div class="find__row">
                            <div class="find__btn-container">
                                <button type="submit" class="btn btn__green find__btn-search">Search</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="find__leave-request-container-info">
                            ...
                            <div class="find__leave-request-container-btn">
                                <buttton class="btn btn__empty-green find__btn-leave"
                                         data-toggle="modal" data-target="#modalRequest-of-a-ride">{{trans( 'ride.Leave request') }}</buttton>
                            </div>
                        </div>
