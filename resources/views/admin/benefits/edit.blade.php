...
<div class="row">
    {{ Form::open(array('url' => 'admin/benefits/edit', 'class'=> 'form-horizontal' )) }}
    <div id="tab_lt" class="admin-tabs-item hide">
        <div class="form-group">
            <label class="control-label col-sm-2" for="text_lt">{{trans( 'admin.Text') }}:</label>
            <div class="col-sm-6">
                {{Form::text( 'text_lt', $benefit["text_lt"], ['id' => 'text_lt', 'class' => 'form-control' ] )}}
            </div>
    ...
    <div id="tab_lv" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'text_lv', $benefit["text_lv"], ['id' => 'text_lv', 'class' => 'form-control' ] )}}
            </div>
    ...
    <div id="tab_ee" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'text_ee', $benefit["text_ee"], ['id' => 'text_ee', 'class' => 'form-control' ] )}}
            </div>
    ...
    <div id="tab_en" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'text_en', $benefit["text_en"], ['id' => 'text_en', 'class' => 'form-control' ] )}}
            </div>
    ...
    <div id="tab_ru" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'text_ru', $benefit["text_ru"], ['id' => 'text_ru', 'class' => 'form-control' ] )}}
            </div>
    ...
    <div id="tab_pl" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'text_pl', $benefit["text_pl"], ['id' => 'text_pl', 'class' => 'form-control' ] )}}
            </div>
    ...
    <div id="tab_generic" class="admin-tabs-item">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label class="radio-inline">{{Form::radio( 'type', 'passanger', $benefit["type"] == 'passanger' )}}{{trans( 'admin.Passanger') }}</label>
                <label class="radio-inline">{{Form::radio( 'type', 'driver',  $benefit["type"] == 'driver' )}}{{trans( 'admin.Driver') }}</label>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="status">{{trans( 'admin.Status') }}:</label>
            <div class="col-sm-6">
                <label class="radio-inline">{{Form::radio( 'active', 1, !empty( $benefit["active"] ) )}}{{trans( 'admin.Active') }}</label>
                <label class="radio-inline">{{Form::radio( 'active', 0, empty( $benefit["active"] ) )}}{{trans( 'admin.Inactive') }}</label>
            </div>
        </div>
    </div>
    <div class="form-group">
