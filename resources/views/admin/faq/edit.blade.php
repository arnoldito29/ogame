...
<div class="row">
    {{ Form::open(array('url' => 'admin/faq/edit', 'class'=> 'form-horizontal' )) }}
    <div id="tab_lt" class="admin-tabs-item hide">
        <div class="form-group">
            <label class="control-label col-sm-2" for="name_lt">{{trans( 'admin.Name') }}:</label>
            <div class="col-sm-6">
                {{Form::text( 'name_lt', $faq["name_lt"], ['id' => 'name_lt', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_lt', $faq["text_lt"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_lv" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_lv', $faq["name_lv"], ['id' => 'name_lv', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_lv', $faq["text_lv"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_ee" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_ee', $faq["name_ee"], ['id' => 'name_ee', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_ee', $faq["text_ee"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_en" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_en', $faq["name_en"], ['id' => 'name_en', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_en', $faq["text_en"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_ru" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_ru', $faq["name_ru"], ['id' => 'name_ru', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_ru', $faq["text_ru"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_pl" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_pl', $faq["name_pl"], ['id' => 'name_pl', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_pl', $faq["text_pl"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_generic" class="admin-tabs-item">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label class="radio-inline">{{Form::radio( 'active', 1, !empty( $faq["active"] ) )}}{{trans( 'admin.Active') }}</label>
                <label class="radio-inline">{{Form::radio( 'active', 0, empty( $faq["active"] ) )}}{{trans( 'admin.Inactive') }}</label>
            </div>
        </div>
    </div>
    <div class="form-group">
