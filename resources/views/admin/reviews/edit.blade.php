...
<div class="row">
    {{ Form::open(array('url' => 'admin/reviews/edit', 'class'=> 'form-horizontal' )) }}
    <div id="tab_lt" class="admin-tabs-item hide">
        <div class="form-group">
            <label class="control-label col-sm-2" for="name_lt">{{trans( 'admin.Name') }}:</label>
            <div class="col-sm-6">
                {{Form::text( 'name_lt', $review["name_lt"], ['id' => 'name_lt', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_lt', $review["text_lt"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_lv" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_lv', $review["name_lv"], ['id' => 'name_lv', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_lv', $review["text_lv"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_ee" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_ee', $review["name_ee"], ['id' => 'name_ee', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_ee', $review["text_ee"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_en" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_en', $review["name_en"], ['id' => 'name_en', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_en', $review["text_en"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_ru" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_ru', $review["name_ru"], ['id' => 'name_ru', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_ru', $review["text_ru"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_pl" class="admin-tabs-item hide">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                {{Form::text( 'name_pl', $review["name_pl"], ['id' => 'name_pl', 'class' => 'form-control' ] )}}
            </div>
        ...
        <div class="row">
            ...
            {{ Form::textarea('text_pl', $review["text_pl"], ['class' => 'ckeditor']) }}
        </div>
    </div>
    <div id="tab_generic" class="admin-tabs-item">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label class="radio-inline">{{Form::radio( 'active', 1, !empty( $review["active"] ) )}}{{trans( 'admin.Active') }}</label>
                <label class="radio-inline">{{Form::radio( 'active', 0, empty( $review["active"] ) )}}{{trans( 'admin.Inactive') }}</label>
            </div>
        </div>
    </div>
    <div class="form-group">
